...
export const ERROR_META = {
  ...
  E607: { category: 'LinearStructError', kind: 'LinearStructNew',
    hint: 'Allocate #[linear] structs manually in linear memory and access via pointer' },
  E608: { category: 'LinearStructError', kind: 'LinearStructAccess',
    hint: 'Use a pointer (e.g. *Point) to access fields of a #[linear] struct' },
  E609: { category: 'LinearStructError', kind: 'LinearStructRefOp',
    hint: '#[linear] structs cannot participate in GC reference operations' },
  E610: { category: 'LinearStructError', kind: 'LinearStructParam',
    hint: 'Use a pointer type (e.g. *Point) for parameters and returns of #[linear] structs' },
